            ...
            <Container style={{position:'relative'}}>
                <View style={{flexDirection: 'row',justifyContent: 'space-around',backgroundColor:'#fff'}}>
                    <TouchableOpacity onPress={()=>this.tabsChange('10003')}>
                          ...
                          <Text style={this.state.tabType==10003?styles.activeTextStyle:styles.tabsText}>系统消息</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={()=>this.tabsChange('10002')}>
                        ...
                        <Text style={this.state.tabType==10002?styles.activeTextStyle:styles.tabsText}>个人消息</Text>
                    </TouchableOpacity>
                </View>
